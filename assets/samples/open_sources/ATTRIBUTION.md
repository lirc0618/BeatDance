...
- 内容：4 秒 breakdance 六步动作；适合测试全身快速动作和地面姿态。
- 作者：Neil Sweeney
- 来源：https://commons.wikimedia.org/wiki/File:6-step_example.gif
- 许可：CC BY-SA 4.0（https://creativecommons.org/licenses/by-sa/4.0/）

## breakdance_2_step

- 内容：6.1 秒 breakdance 两步示范；适合测试节奏与脚步轨迹。
- 作者：VincaniTV
- 来源：https://commons.wikimedia.org/wiki/File:Demonstration_of_a_2-step.webm
- 许可：CC BY 3.0（https://creativecommons.org/licenses/by/3.0/）

## simple_step

- 内容：3.8 秒简单踏步；适合测试普通站立动作与短视频边界。
- 作者：Secarver7
- 来源：https://commons.wikimedia.org/wiki/File:Simple_step_demo.ogv
- 许可：CC BY 3.0（https://creativecommons.org/licenses/by/3.0/）

## six_step_tutorial

- 内容：107 秒 breakdance 六步完整教程；用于测试长 Feed 的任意时刻暂停。
- 作者：Neil Sweeney
- 来源：https://commons.wikimedia.org/wiki/File:Tutorial_breakdance_-_Six_Step.webm
- 许可：CC BY 3.0（https://creativecommons.org/licenses/by/3.0/）

## arm_movements_veil

- 内容：12 秒竖屏手臂运动片段；用于测试手部动作暂停与局部解释。
- 作者：Fabiola Mastache
- 来源：https://commons.wikimedia.org/wiki/File:Movimientos_con_velo.webm
- 许可：CC BY-SA 4.0（https://creativecommons.org/licenses/by-sa/4.0/）

## cha_cha_dance

- 内容：48 秒恰恰舞片段；用于测试长 Feed 脚步动作的暂停定位。
- 作者：Wpzhiyilee
- 来源：https://commons.wikimedia.org/wiki/File:Cha_cha_cha(Dance).webm
- 许可：CC BY-SA 3.0（https://creativecommons.org/licenses/by-sa/3.0/）

## tendu_tutorial

- 内容：16 秒单人芭蕾脚尖伸展教程；用于测试落点、方向与回位暂停。
- 作者：Tcshaw427
...
- `arm_movements_reference.mp4`：手臂路线诊断参考；截取源视频 0–5 秒。
- `tendu_reference.mp4`：Tendu 诊断参考；截取源视频 4–9 秒。
